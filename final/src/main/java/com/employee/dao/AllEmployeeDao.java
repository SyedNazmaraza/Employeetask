...
//	public List<AllEmployee> getEmployeeFilterByName(AllEmployee employee , Connection c){
//		List<AllEmployee> l1 = new ArrayList<AllEmployee>();
//		PreparedStatement preparedstatement = c.prepareStatement(null)
//	}
